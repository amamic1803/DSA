 ...
 *
 * This function performs a Gaussian elimination on a matrix to reduce it to row-echelon form.
 *
 ...
 *
 * This function performs a Gauss-Jordan elimination on a matrix to reduce it to reduced row-echelon form.
 *
 * @param matrix The matrix to reduce.
 * @param n The number of rows in the matrix.
 * @param m The number of columns in the matrix.
